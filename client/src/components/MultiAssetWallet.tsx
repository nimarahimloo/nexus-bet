...
export function MultiAssetWallet() {
  ...
  const networkOptions = selectedAsset?.code === "USDT" && selectedAsset.networks.includes("BEP20") ? ["BEP20"] : (selectedAsset?.networks ?? []);
  const selectedNetwork = network || networkOptions[0] || "";
