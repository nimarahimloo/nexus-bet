...
- [ ] تکمیل قابلیت‌های اصلی sportsbook شامل جست‌وجو، مسابقات محبوب، بازارهای بیشتر، live center و history.
- [x] بازطراحی bet slip و مسیر تأیید برای موبایل با microcopy طبیعی‌تر.
- [ ] بازنویسی متن‌های عمومی و ماشینی سراسر سایت با لحن کوتاه، انسانی و قابل‌اعتماد.
